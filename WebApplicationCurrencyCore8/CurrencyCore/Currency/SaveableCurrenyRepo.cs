...
namespace Currency
{
    ...
    public class SaveableCurrenyRepo : CurrencyRepo, ISerializable
    {
        ...
        public SaveableCurrenyRepo() : this(new List<ICurrency>())
        {

        }

        public SaveableCurrenyRepo(List<ICurrency> currency) : base(currency)
        {
            Path = "MyFile.bin";
        }
        ...
        public bool Save()
        {
            ...
            formatter.Serialize(stream, this.Currency);
            stream.Close();
            return true;
        }
